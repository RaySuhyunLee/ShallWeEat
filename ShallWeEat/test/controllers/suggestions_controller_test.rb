...
#   		questions.include?('Are you starving to death?')
  ...
  test "#search_food" do
    sug_con = SuggestionsController.new()
		...
		Food.create(name: "chicken_original", spicy: 20, sour: 5, sweet: 50, salty: 50, bitter: 5, hot: 70, cold: 30, calories: 247, time: 50, price: 50) 		
		Food.create(name: "ramen", spicy:70, sour:0, sweet:20, salty:30, bitter:0, hot:80, cold:20, calories:385, time:5, price:5)		
		Food.create(name: "steak", spicy:10, sour:5, sweet:60, salty:40, bitter:0, hot:40, cold:60, calories:252, time:80, price:85)
